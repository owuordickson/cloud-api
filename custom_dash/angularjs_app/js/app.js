...
gostApp.config(function ($routeProvider) {
    $routeProvider.
        ...
        when('/acograd', { templateUrl: 'views/acograd.html', controller: "AcoGradCtrl" }).
...
var iconAcograd = "fa-balance-scale";
...
function getPysocketUrl() {   
    if (typeof wsURL !== 'undefined' && wsURL != "") {
        return wsURL   
    } else { 
        var scheme = getSSLEnabled() ? "https://" : "http://";
        return scheme + location.hostname + ":8088" + "/";
    }
}
